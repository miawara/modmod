...
public enum PunishmentTrack {
    ...
    SEVERELY_INAPPROPRIATE_CHAT("Extremely Inappropriate Chat Messages", new PunishmentEscalation(ServerPunishmentType.MUTE,0, PunishmentDuration.D30, PunishmentDuration.PERM), List.of("(Severely|Extremely|Very|Disturbing|explicit|super) Inappropriate (Chat|Topics|message)", "pedo(|philia)", "Sexual", "creepy", "grooming", "erotic")),
    ...
    SERVER_CRASHING("Intentional Server Crashing", new PunishmentEscalation(ServerPunishmentType.BAN,0, PunishmentDuration.PERM, PunishmentDuration.PERM), List.of("Crashing (Server|Node|diamondfire)", "Server (Crash|Crashing|Crashes|Node)", "Intentionally Crashing (Server|Node)", "Intentional (Server|Node) Crashing", "crash Exploit")),
