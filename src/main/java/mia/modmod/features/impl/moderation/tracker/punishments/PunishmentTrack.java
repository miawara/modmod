...
public enum PunishmentTrack {
    ...
    FILTER_BYPASS("Filter Bypass", new PunishmentEscalation(ServerPunishmentType.MUTE,3, PunishmentDuration.D1, PunishmentDuration.D14), List.of("Filter Bypass", "Bilter Bypass", "bypassing filter", "chat filter bypass", "bypass filter", "swearing")),
    ...
    INAPPROPRIATE_CHAT("Inappropriate Chat Message", new PunishmentEscalation(ServerPunishmentType.MUTE,0, PunishmentDuration.D14, PunishmentDuration.PERM), List.of("^Inappropriate (Chat|Topic|message)")),
